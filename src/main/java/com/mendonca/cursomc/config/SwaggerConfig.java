package com.mendonca.cursomc.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("com.mendonca.cursomc.resources")).paths(PathSelectors.any())
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				...
				new Contact("Deivid Mendonça", "https://github.com/uniom3/spring-ionic-backend",
						"mendonca.deivid@outlook.com"),
